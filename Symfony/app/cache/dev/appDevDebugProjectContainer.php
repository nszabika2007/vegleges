...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_5ed450564c4fc379192ad9fa993ce77325835eea49acfa8741cdf0edd90aadd7');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_5ed450564c4fc379192ad9fa993ce77325835eea49acfa8741cdf0edd90aadd7');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_5ed450564c4fc379192ad9fa993ce77325835eea49acfa8741cdf0edd90aadd7');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/opt/lampp/htdocs/Symfony/src/Diff/UserBundle/Resources/config/doctrine' => 'Diff\\UserBundle\\Entity', '/opt/lampp/htdocs/Symfony/src/Diff/BassicLayoutBundle/Resources/config/doctrine' => 'Diff\\BassicLayoutBundle\\Entity', '/opt/lampp/htdocs/Symfony/src/Diff/LoginBundle/Resources/config/doctrine' => 'Diff\\LoginBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/opt/lampp/htdocs/Symfony/src/Diff/AdminBundle/Entity', 1 => '/opt/lampp/htdocs/Symfony/src/Diff/OrderTripBundle/Entity'));
    ...
    {
        return $this->services['knp.snappy.pdf'] = new \Knp\Snappy\Pdf('/usr/local/bin/wkhtmltopdf', array('lowquality' => false, 'enable-javascript' => false, 'debug-javascript' => false));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/lampp/htdocs/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/opt/lampp/htdocs/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/opt/lampp/htdocs/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/lampp/htdocs/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/opt/lampp/htdocs/Symfony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSiphoc_Pdf_CssToHtmlService()
    {
        ...
        $instance->setBasePath('/opt/lampp/htdocs/Symfony/app/../web');
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/opt/lampp/htdocs/Symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/opt/lampp/htdocs/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/opt/lampp/htdocs/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/UserBundle/Resources/views', 'User');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/BassicLayoutBundle/Resources/views', 'BassicLayout');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/AdminBundle/Resources/views', 'Admin');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/LoginBundle/Resources/views', 'Login');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/OrderTripBundle/Resources/views', 'OrderTrip');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/FileHandlerBundle/Resources/views', 'FileHandler');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Diff/StatsBundle/Resources/views', 'Stats');
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        ...
        $instance->addPath('/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/lampp/htdocs/Symfony/app/../web', true);
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/opt/lampp/htdocs/Symfony/src/Diff/OrderTripBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => '/opt/lampp/htdocs/Symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/opt/lampp/htdocs/Symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/opt/lampp/htdocs/Symfony/src/Diff/OrderTripBundle/Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/opt/lampp/htdocs/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => '/opt/lampp/htdocs/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'swiftmailer.spool.default.memory.path' => '/opt/lampp/htdocs/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'siphoc_pdf.basepath' => '/opt/lampp/htdocs/Symfony/app/../web',
