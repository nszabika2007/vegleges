...
class __TwigTemplate_7de4a77b7262be1495a3e1dba7f44f588f70427b3b3520edd65265547774e57d extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_848c7d465c685caeae362f62d06a889e484024f7f81087df127b862611ef9554"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_848c7d465c685caeae362f62d06a889e484024f7f81087df127b862611ef9554"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_848c7d465c685caeae362f62d06a889e484024f7f81087df127b862611ef9554"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_848c7d465c685caeae362f62d06a889e484024f7f81087df127b862611ef9554"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_848c7d465c685caeae362f62d06a889e484024f7f81087df127b862611ef9554"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 451
            $context["__internal_66ce7bcf425cd5c57f55b50c5848296a71672bf892a75fa0d480adb5fc18dda1"] = $this;
            // line 452
            echo "                {
                    \"id\": \"";
            // line 453
...
";
            // line 456
            echo $context["__internal_66ce7bcf425cd5c57f55b50c5848296a71672bf892a75fa0d480adb5fc18dda1"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
